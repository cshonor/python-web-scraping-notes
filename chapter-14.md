...
可运行脚本：`code/chapter14/selenium_honey_demo.py`
...
- **headers_session**：`code/chapter14/headers_session.py` 演示 `requests.Session` + 自定义头。  
...
`code/chapter14/headers_session.py`：最小 UA + Session 示例。
