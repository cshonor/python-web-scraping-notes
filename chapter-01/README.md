...
仓库内可执行脚本：`chapter-01/get_title_urllib.py`
...
若你已熟悉 **`requests`**，也可对照阅读 `chapter-01/get_example.py`、`bs4_example.py`、`safe_get.py`，二者与 `urllib` 路线互补，后续章节中 `requests` 出现频率更高。
